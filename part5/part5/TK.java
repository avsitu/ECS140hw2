...
public class TK {
    ...
    public static final TK ASSIGN = new TK("TK.ASSIGN");   // assign
    public static final TK ENDDO  = new TK("TK.ENDDO");   // enddo   
    public static final TK TILDE  = new TK("TK.TILDE");   // TILDE    
    
    public static final TK EOF    = new TK("TK.EOF");	   // end of file
    
    //testing part 5 here
    public static final TK FOR    = new TK("TK.FOR"); // ^ for
    public static final TK ENDFOR = new TK("TK.ENDFOR"); // ^ end for
    public static final TK COMP   = new TK("TK.COMP"); // & comp
    // end testing
